...
Agenda.prototype.saveJob = function(job, cb) {
  ...
  if (id) {
    console.log('                     UPDATING JOB... (%s, named "%s", someId=>%s)',id, job.attrs.name, job.attrs.someId);
  ...
  // (i.e. "update if it exists, otherwise create")
    ...
    console.log('                     UPSERTING JOB... (named "%s", someId=>%s)', job.attrs.name, job.attrs.someId);
  ...
  // Otherwise just create a new record for the job.
    ...
    console.log('                     CREATING NEW JOB... (named "%s", someId=>%s)', job.attrs.name, job.attrs.someId);
